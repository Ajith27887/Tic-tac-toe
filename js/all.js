const myDiv = document.querySelectorAll("button");
const displayWin = document.querySelector(".win").querySelector("h1");
const displayAlert = document.querySelector(".win").querySelector("h2");
const displayBoard = document.querySelector(".win")
...
function myFunction() {
    if ((myDiv[0].innerHTML === "x" || myDiv[0].innerHTML === "X") && (myDiv[1].innerHTML === "x" || myDiv[1].innerHTML === "X") && (myDiv[2].innerHTML === "x" || myDiv[2].innerHTML === "X")) {
        ...
        displayWin.innerHTML = "Player X Won the match";
        ...
        myDiv[4].disabled = true;
        myDiv[7].disabled = true;
    } else if ((myDiv[0].innerHTML === "x" || myDiv[0].innerHTML === "X") && (myDiv[4].innerHTML === "x" || myDiv[4].innerHTML === "X") && (myDiv[8].innerHTML === "x" || myDiv[8].innerHTML === "X")) {
        displayBoard.style.display = "block"
        displayWin.innerHTML = "Player X Won the match";
        closeAlert.addEventListener("click", () => {
            location.reload();
        ...
        myDiv[4].disabled = true;
        myDiv[7].disabled = true;
    } else if ((myDiv[0].innerHTML === "o" || myDiv[0].innerHTML === "O") && (myDiv[4].innerHTML === "o" || myDiv[4].innerHTML === "O") && (myDiv[8].innerHTML === "o" || myDiv[8].innerHTML === "O")) {
        displayBoard.style.display = "block"
        displayWin.innerHTML = "Player 'X' Won the match";
        closeAlert.addEventListener("click", () => {
            location.reload();
